...
public class Pokemon {
    ...
    public Pokemon(int numPokedex, Integer generacion, String nombre, Integer nivel, List<TipoPokemon> tipos, Stats stats, List<LineaEvolutiva> lineaEvolutiva, List<Movimiento> movimientos) {
