...
public class TablaController {
    ...
    public void initialize() {
        cargarTabla();
        filtrarId.textProperty().addListener((obs, old, nuevo) -> aplicarFiltros());
    ...
    public void aplicarFiltros() {
        String filtroId = filtrarId.getText().toLowerCase();
        ...
        List<Holocron> filtradoParcial = listaOriginalHolocrons.stream()
                .filter(holocron -> filtroId.isEmpty() ||
                        holocron.getId().toString().equals(filtroId))
