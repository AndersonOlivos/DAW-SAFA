        ...
        <div>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", gap: "2rem" }}>
                <div style={{ display: "flex",flexDirection: "column", justifyContent: "flex-start" , gap: "2rem"}}>
                    ...
                    <a
                        style={{backgroundColor:"whitesmoke", padding: "0.5rem 1rem", cursor: "pointer", borderRadius: "10px"}}
                        href="#"
                       onClick={e => {
                           e.preventDefault();
                           addLog("click", "enlace");
                    ...
                    <div
                        style={{ width: "200px", height: "100px", border: "1px solid white", borderRadius: "10px", cursor: "pointer" }}
                        onClick={e =>
